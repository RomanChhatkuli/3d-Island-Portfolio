        ...
        <div>
            <ul className="example-2">
                <li className="icon-content">
                    <a href="https://np.linkedin.com/in/roman-chhatkuli-49108130a" aria-label="LinkedIn" data-social="linkedin"
                        target="_blank">
                ...
                <li className="icon-content">
                    <a href="https://github.com/RomanChhatkuli" aria-label="GitHub" data-social="github" target="_blank">
                        <div className="filled"></div>
                ...
                <li className="icon-content">
                    <a href="https://www.instagram.com/roman_chhatkuli/?hl=en" aria-label="Instagram" data-social="instagram"
                        target="_blank">
                        <div className="filled"></div>
